...
namespace BadEggStudio.Utils
{
     ...
     */
		...
		// |		Main called methods		  |
		// ====================================
		#region Main Called Methods
		/// <summary>
		/// Using AES encrtpyion to encrypt the specified string input.
		/// </summary>
		...
		/// <summary>
		/// Using AES decryption to decrypt the specified encrypted string input.
		/// </summary>
